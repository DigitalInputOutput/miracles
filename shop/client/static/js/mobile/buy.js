export class Buy{
    constructor(){
        this.timeout = NaN;
        this.cartButton = Dom.query('#cart-button');
        this.toTarget = Dom.query('#cart-button');

        Dom.query('.buy').on('click touch',this.buy.bind(this));

        Dom.query('.quantity .minus').on('click touch',this.minus.bind(this));
        Dom.query('.quantity .plus').on('click touch',this.plus.bind(this));
