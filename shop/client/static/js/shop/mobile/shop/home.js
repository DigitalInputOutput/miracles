export class Home extends Buy{
    constructor(){
        super();
        this.sliderLength = Dom.query('#slider a').length;
        this.index = 0;
        this.touchStartPosition;
        this.sliderTimeout;
        this.verbose = false;
        this.container = Dom.query('#slider');
        this.image = Dom.query('#slider a')[0];
        this.touchEndPosition = 0;

        if(Dom.query('#slider a').length > 1){
        ...
        new Navigation(Dom.query('main .navigation')[0]);
    }
    start(e){
