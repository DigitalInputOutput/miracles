export class Navigation{
    constructor(container){
        ...
        Dom.query('#menu').on('scroll',this.resizeBackButton.bind(this));
    ...
    resizeBackButton(e){
        var top = ((window.screen.height - 264) - Dom.query('#menu .navigation')[0].offsetTop) + Dom.query('#menu').scrollTop;
