...
from system.settings import DOMAIN,LANGUAGE_SESSION_KEY
from django.views.decorators.csrf import csrf_exempt
import hmac
from shop.models import Settings

try:
    from system.settings import CHECKOUT_TYPE,LIQPAY_PUBLIC,LIQPAY_PRIVATE
except:
    CHECKOUT_TYPE = 'liqpay'
    LIQPAY_PUBLIC,LIQPAY_PRIVATE = '',''
