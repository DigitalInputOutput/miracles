...
from checkout.models import Order,City,Department,Seat
from manager.forms import SeatForm
from json import loads
from requests import post,get
from django.utils import timezone
from shop.models import Settings
from system.settings import PHONES
import re

VOLUME_MAX = 70

try:
    from system.settings import AOC
except:
    AOC = False
...
def ttn(request):
    ...
    departament = get_object_or_404(Department,type=1,id=request_data['order'].get('departament'))
