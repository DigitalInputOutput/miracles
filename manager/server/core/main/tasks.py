...
from system.settings import BASE_DIR,DOMAIN,CACHE_URL,STATIC_ROOT,COMPANY_NAME
...
try:
    from system.settings import PARENT_DATABASE
except:
    PARENT_DATABASE = None

try:
    from system.settings import HOST,PROTOCOL
except:
    HOST = PROTOCOL = None
