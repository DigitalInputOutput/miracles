...
export class BetterFormMetaclass(BetterFormBaseMetaclass,
                          forms.forms.DeclarativeFieldsMetaclass):
    pass


export class BetterModelFormMetaclass(BetterFormBaseMetaclass,
...
export class BetterForm(with_metaclass(BetterFormMetaclass, BetterBaseForm),
                 forms.Form):
    __doc__ = BetterBaseForm.__doc__


export class BetterModelForm(with_metaclass(BetterModelFormMetaclass,
